        ...
        <div className="block md:flex items-center">
          ...
          <div class="order-0 md:mr-40">
            ...
            <p className="my-6 md:my-8">
              Hello, I’m <span className="text-secondary dark:text-secondary-dark">Luis Cruz</span>, a
              Front-End Software Developer located in Bogota Colombia, I’ve been
              building and deploying things on the web since 2002, I love to
              create beautiful and clean UI focused on the best performance and
              UX practices.
            </p>
